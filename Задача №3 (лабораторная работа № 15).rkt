...
(define (field pol1 pol2 k)
  (cond [(<= k (compare_r pol1 pol2)) (foldl (λ (i y) (+ (* (list-ref (reverse (largest pol1 pol2)) (- (compare_l pol1 pol2) i)) (list-ref (reverse (smallest pol1 pol2)) (+ (- (compare_r pol1 pol2) k) i))) y)) 0 (build-list (+ k 1) +))]
        ...
        [else (foldl (λ (i y) (+ (* (list-ref (reverse (largest pol1 pol2)) (- (- (+ (compare_r pol1 pol2) (compare_l pol1 pol2)) k) i)) (list-ref (reverse (smallest pol1 pol2)) i)) y)) 0 (build-list (+ (- (+ (compare_r pol1 pol2) (compare_l pol1 pol2)) k) (if (or (> (compare_r pol1 pol2) 0) (= (- (+ (compare_r pol1 pol2) (compare_l pol1 pol2)) k) 0))  1 0)) +))]
        )
        )
